...
values stored in the former are not guaranteed to be recalled with 100-percent fidelity. 


Suppose there existed some database of words where ``kat" appeared once and the word ``cat" appeared 100 times.
