...
\begin{abstract}
    ...
    fidelity. At the user level, this library will provide an intuitive interface to this probabilistic
...
With probabilistic memories, for a given query, the most ``likely" candidate 
