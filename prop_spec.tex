...
ability to query for a match of one two or both pairs. Functions that transform
...
%To accomplish this, we will write the same (or a similar) applications using a standard, non-probabilistic memory model
